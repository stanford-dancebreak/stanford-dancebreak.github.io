...
- **Prepare your lesson plan.** Write out which *techniques* you plan to cover and which *songs* (including BPM) and *activities* you plan to use to teach these. Lessons should be an hour in total, but it is a good rule of thumb to plan for ~50 minutes, to allow for transitions and unexpected pacing.
    ...
    - Our current catalog is available [here](https://www.notion.so/266fe184d678800c83d7e639bed6ffd3?pvs=21)!
...
Heavy focus on connection and listening. We prioritize this over “vocab” but using vocab as context to explore ways to connect.
...
For some example lesson plans, see [here](https://www.notion.so/266fe184d678800c83d7e639bed6ffd3?pvs=21)
...
- **Maximize practice time, minimize talking time.**
    ...
    - The best dance classes are a sequence/progression of drills that increase in difficulty that allow people to discover things on their own while music is playing by trying. Dance is best learned through experience, not spoken word.
...
- **Plan a sequence/progression of drills**
    ...
    - Formulate drills as a challenge “if you can do drill1, can you do drill2?”. Examples of drills that form the next step in a progression:
        - Drill1: Leads press into your partner’s hand to prep a turn. Follows verbally say whether they think it will be a single turn, double turn, triple turn, half speed turn.
    ...
    - Exception: If you’re teaching a new pattern or step sequence, it may take a couple minutes to explain before they’re ready to do it. Invite students to copy you as you step them through it, instead of showing them all the steps then having them try to replicate several steps in a row.
- **High energy warmup to get people engaged fast**
...
- **Create a playlist**
    - Check that songs are in richard’s bpm range: https://www.richardpowers.com/dj-tips
    - Check that songs have a clear beat without weird phrase changes.

### Acknowledgements

Thank you to Cameron Schaeffer for feedback and wording suggestions in the “Lesson Plans” section!