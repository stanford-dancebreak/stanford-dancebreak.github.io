...
- **Foster creativity and build intuition around "dance grammar."** We want students to leave the classes with a deeper understanding of the particular dance as well as the component pieces that make up it and other dances.  This "dance grammar" helps build a strong foundation when it comes to continue to learn this particular dance as well as teaching a stable base that provides agency and technically sound building blocks for all their future dance learning.
...
- **Find a teaching partner.** Each lesson should have at least one experienced instructor, so if you are still working to be an experienced instructor, please pair up with a veteran. If you don't have a partner in mind, the Dancebreak admin team can help you find someone.
...
- **Prepare your lesson plan.** Write out which _techniques_ you plan to cover and which _songs_ (including BPM) and _activities_ you plan to use to teach these. Lessons should be an hour in total, but it is a good rule of thumb to plan for ~50 minutes, to allow for transitions and unexpected pacing.
	...
	- Our current catalog is available [here](https://www.notion.so/266fe184d678800c83d7e639bed6ffd3?v=266fe184d67880918490000cb6146bff)!
...
- **Send us a class description for advertising purposes.** Please include the prerequisites as needed.
...
- **Avoid gendered terminology** around Lead/Follow and around role responsibilities
	...
	- In a balanced partner dance, both parties have technique, mechanics, and connection that contribute to the success of the dance. We do not espouse “it’s always the Lead’s fault” – this is unfair to Leads and disempowering to Follows.
...
- **Minimize talking time, maximize practice time.** Dance is best learned through experience, not spoken word.
...
- Feel free to make your job easier by using our collection of lesson plans!
...
For some example lesson plans, see [here](https://www.notion.so/266fe184d678800c83d7e639bed6ffd3?v=266fe184d67880918490000cb6146bff)
...
- **Plan a sequence/progression of exercises**
	- 1st exercise is the simplest version of what you want to teach
		- Formulate exercises as a challenge “if you can do the first one, can you do the second one?”.
...
- **Create a playlist**
	- Check that songs are in Richard’s bpm range:[ https://www.richardpowers.com/dj-tips](https://www.richardpowers.com/dj-tips). Remember that djing guidelines are often faster then learning speeds. Play on the lower edge of a dances range if not slower outside of a speed class.
	- Remember to play simple songs unless the class is targeted at that particular aspect of improvement.

## Acknowledgements


Thank you to Maiya Yu for guiding the creation of these guidelines, which we adapted from SSD and Cameron Schaeffer and Stefan Warmuth for feedback and wording suggestions in the “Lesson Plans” section!