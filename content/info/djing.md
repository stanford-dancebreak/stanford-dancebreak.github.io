...
- **Watch this video** from Richard Powers about how to DJ: https://youtu.be/u7k_4HdbfIA
    - Richard has a lot of other great DJ tips on [his website](https://www.richardpowers.com/dj-tips), and many of our guidelines are adapted from his. He was also kind enough to teach a more detailed lesson at Dancebreak (which
...
- **Prepare a setlist.** Follow the guidelines set forth later in this document.
    - Use [this template](https://docs.google.com/spreadsheets/d/1VyzeTifbRCLQ-v-k9aoITP4AOAMEhlZChjp1DYka1UI/edit?usp=sharing) to help organize your music
...
- **Send the admin team your setlist. At least a week before your set, send us your song list, including any potential edits you plan to make. This way, we can review and give feedback before the set.**
    - **All of your songs should fit within the guidelines below.** In particular, pay attention to song length, tempo guidelines, and the sequence of last dances. If you would like help finding songs that are danceable and beginner-friendly, reach out to the admin team. We are currently building out a catalog of pre-approved songs for Waltz, WCS, and Lindy Hop, including a [collection of pre-approved edits](https://drive.google.com/drive/folders/1llLqmxZBG-UO81-YMlp3e9UkOT0sTS4C?usp=drive_link).
...
A 2-hour social typically includes ~30-35 songs, including time for a jam. Of the first 5 songs in the set, at least 2 should be of the style taught in the lesson, to make a smooth transition.
...
| **Dance Style** | **Target BPM** | **Extended BPMs** |
| --- | --- | --- |
| Cross-Step Waltz | 116 | 114-122 |
| Rotary Waltz | 144 | 140-160 |
| Fast Waltz | 170 | 170-200 |
| Polka | 114 | 110-125 |
| Lindy Hop | 140 | 130-160 |
| West Coast Swing | 110 | 90-120 |
| Nightclub Two Step | 82 | 80-85 |
| Fusion | 70 | 65-90 |

If a style is not in this table (e.g., many Latin dances), the song should follow the typical tempo range for a beginner-intermediate dancer. Feel free to reference [this guide](https://garron.net/dance/tempos/) from Lucas Garron for additional BPM ranges.

A small number of songs in each set (0-3) may violate the norms of a particular dance style; however, these should be waltzes, played near the end of the set, and explicitly called out as advanced songs.
...
- 1-3 Mixers (must be taught)
    ...
    - 't Smidje Mixer
    - Chaos Mixer
    - [Circassian Circle](https://www.youtube.com/watch?v=RfQs_vtgW6o)
    - [Irish Céilí](https://www.youtube.com/watch?v=VdP7m-W470U)
    - Swing Rueda
    - West Coast Swing Mixer (DJ must call "rotate")
- 4-6 Lindy Hop
    - Consider using the songs from the [Approved Lindy Hop](https://www.notion.so/Approved-Lindy-Hop-276fe184d6788063b96bda03e4ab1d0d?pvs=21) lists (SSD setlists).
- 4-6 West Coast Swing
    - Feel free to use songs from [this](https://open.spotify.com/playlist/3tLyLIetButHdRgLo8R2Z8?si=88f2be159bc44c91) approved Spotify Playlist, which is sorted by BPM.
- 0-4 Other Swing
    - Charleston
    - Bugg (4 Count Swing)
    - Shag
...
- Cutting songs which are too long (over 3.5 minutes), or looping sections of songs which are too short (under 2 minutes).
- Truncating long intros and outros.
- Removing sections of a song without a consistent beat.

You are welcome to edit with whatever program you prefer, including [Audacity](https://www.audacityteam.org/), [Cakewalk](https://www.cakewalk.com/), [GarageBand](https://www.apple.com/mac/garageband/), a custom Python script, or anything else.
...
[Approved Last Waltzes](https://www.notion.so/266fe184d678801ca898c60209604042?pvs=21)